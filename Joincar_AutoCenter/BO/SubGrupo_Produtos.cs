    ...
    public class SubGrupo_Produtos 
    {
        ...
        private void Load()
        {
            try
            {
                ...
                {
                    dr.Read();
                    this.SGP_ID     = dr.GetSqlInt32(0).Value;
                    this.SGP_CODIGO = dr.GetSqlInt32(1).Value;
                    this.SGP_GRUPO  = dr.GetSqlInt32(2).Value;
                    this.SGP_NOME   = dr.GetSqlString(3).Value;
                    this.SGP_OBS    = dr.GetSqlString(4).Value;
                }
                else
                {
                    SGP_CODIGO = 0;
