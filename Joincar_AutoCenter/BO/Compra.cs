...
namespace BO
{
   public class Compra
   {
       ...
       {
           get { return _COM_FORNECEDOR; }
           set { _COM_FORNECEDOR = value; }
       }
       ...
       public Compra(int COM_CODIGO)
        {
            this._COM_CODIGO = COM_CODIGO;
            this.Carregar();                                                                       
        }

       public Compra(int COM_CODIGO, int COM_NF, int COM_FORNECEDOR, int COM_TIPO_PAGTO, int COM_CANCELADO, float COM_OUT_DESPESAS, 
           float COM_FRETE, float COM_ACRESCIMO, float COM_DESCONTO, float COM_TOTAL, DateTime COM_DATA, DateTime COM_ALTERACAO,
           DateTime COM_DATA_CANCELADO, string COM_OBS, int COM_LANCAMENTO, string FOR_NOME)
        {
            this._COM_CODIGO = COM_CODIGO;
            this._COM_NF = COM_NF;
            this._COM_FORNECEDOR = COM_FORNECEDOR;
        ...
        private void Carregar()
        {
            try
            {
                ...
                this._CONSULTA.Append("COM_OBS, COM_LANCAMENTO FROM Compra WHERE COM_CODIGO = @COM_CODIGO ");
                ...
                if (dr.HasRows)
                {
                    ...
                    this._COM_FORNECEDOR = dr.GetSqlInt32(2).Value;
        ...
        public void Salvar()
        {
            try
            {
                ...
                if (this._COM_CODIGO == 0)
                {
                    ...
                    this._CONSULTA.Append("INSERT INTO Compra ( COM_NF, COM_FORNECEDOR, COM_TIPO_PAGTO, COM_CANCELADO, ");
                    this._CONSULTA.Append("COM_OUT_DESPESAS, COM_FRETE, COM_ACRESCIMO, COM_DESCONTO, COM_TOTAL, COM_DATA, COM_ALTERACAO, ");
                    this._CONSULTA.Append("COM_DATA_CANCELADO, COM_OBS, COM_LANCAMENTO ) ");
                    this._CONSULTA.Append("VALUES ( @COM_NF, @COM_FORNECEDOR, @COM_TIPO_PAGTO, @COM_CANCELADO, ");
                    this._CONSULTA.Append("@COM_OUT_DESPESAS, @COM_FRETE, @COM_ACRESCIMO, @COM_DESCONTO, @COM_TOTAL, @COM_DATA, @COM_ALTERACAO, ");
                    this._CONSULTA.Append("@COM_DATA_CANCELADO, @COM_OBS, @COM_LANCAMENTO ) ");
                ...
                {
                    this._CONSULTA.Append("UPDATE Compra SET COM_NF = @COM_NF, COM_FORNECEDOR = @COM_FORNECEDOR, ");
                    ...
                    this._CONSULTA.Append("COM_LANCAMENTO = @COM_LANCAMENTO WHERE COM_CODIGO = @COM_CODIGO ");
                }
                ...
                cmd.Parameters.Add("@COM_FORNECEDOR", SqlDbType.Int);
                cmd.Parameters[2].Value = this._COM_FORNECEDOR;
